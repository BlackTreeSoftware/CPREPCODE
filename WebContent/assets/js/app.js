...
+function ($) { "use strict";
  var Bjax = function (element, options) {
    ...
    this.$element  = $(element)
    //alert("B4 Calling Start in Constructor");
    this.start()
  ...
  Bjax.prototype.start = function () {
	//alert("Calling the Start Function");
    var that = this;
    this.backdrop();
    //alert("Return to the Start Function");
  ...
  Bjax.prototype.complete = function (){
    var that = this;
    //alert("Calling Complete Function"+this.options.url);
    try{
  ...
  Bjax.prototype.backdrop = function(){
	...
	//alert("Calling Backdrop Function");
    ...
    //alert("Add CSS to backdrop");
  }

  Bjax.prototype.update = function (){
	//alert("Entered Into Update Function");
  ...
  Bjax.prototype.enable = function (e){
	...
	//alert("Next Entered Into Enable");
    var link = e.currentTarget;
    //alert("Link : "+link+"\t Protocal : "+link.protocol+" \t Hostname : "+link.hostname);
  ...
  $(document).on('click.app.bjax.data-api', '[data-bjax], .nav-primary a', function (e) {
	//alert("Entered Into Document Function");
    ...
    //alert("In Document, Click Function");
    //alert("This "+$this+" Url : "+$url+" Target : "+$target+" Option : "+option);
    $target.bjax(option);
    e.preventDefault();
  })
}(jQuery);

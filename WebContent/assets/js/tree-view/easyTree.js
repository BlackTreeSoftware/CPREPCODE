        ...
        this.each(function () {
            ...
            $.each($(easyTree).find('ul > li'), function() {
                ...
                if($(this).is('li:has(ul)')) {
                    ...
                    $(children).remove();
                    text = $(this).text();
                    $(this).html('<span><span class="fa fa-plus-square"></span> &nbsp; &nbsp; <a href="javascript: void(0);"></a> </span>');
                    $(this).find(' > span > span').addClass('fa');
                    $(this).find(' > span > a').text(text);
                    $(this).append(children);
                }
                else {
                    text = $(this).text();
                    $(this).html('<span><span class="fa fa-minus-square"></span> &nbsp; &nbsp; <a href="javascript: void(0);"></a> </span>');
                    $(this).find(' > span > span').addClass('fa');
                    $(this).find(' > span > a').text(text);
                }
            });

    ...
    var h = function(a) {
        this.messages = {
            ...
            type: {
				...
				alpha: "This value should be alphabets.",
				range: "The target score must be in between 260-340.",
    ...
    j.prototype = {
        ...
        applyValidators: function() {
            ...
            for (b in this.constraints) {
                var c = this.Validator.validators[this.constraints[b].name](this.val, this.constraints[b].requirements, this); ! 1 === c ? (a = !1, this.constraints[b].valid = a, this.options.listeners.onFieldError(this.element, this.constraints, this)) : !0 === c && (this.constraints[b].valid = !0, a = !1 !== a, this.options.listeners.onFieldSuccess(this.element, this.constraints, this))
                }
            return a
        },

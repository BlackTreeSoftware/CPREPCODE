...
function returnToQuestion(returnValue)
{
	alert(returnValue);
}
								...
								<div class="row mt-5-per mb-5-per">
											<div class="well-practice practice-content ">
												<div class="col-xs-12 col-sm-10 col-sm-offset-1  col-lg-8 col-lg-offset-2 m-t" >
													<!--  <center> <span id="m_timer"></span></center> -->
													 <hr>
												...
												<p>Click <a href="#" class="btn btn-primary btn-test" onclick="returnConfirm()">Return</a> to keep writing or revising. Click <strong><!-- <a href="#" onclick="confirm(message, callback)">Continue</a> --></strong> to leave this question.</p>

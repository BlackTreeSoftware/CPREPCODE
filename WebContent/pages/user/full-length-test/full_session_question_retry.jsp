...
function getPracticeSessionQuestion(){
	...
	$('#index').val('0');
	//alert('From Fulll Length Review : '+qid);
...
if(array.length>0){
	...
	{ 
		...
		// //alert('in review');
		 window.location = "full_length_result.action?testno="+'<s:property value="#session.test_no"/>'+"";
    ...
    <div id="FirstRow" >
        ...
        <div class="btn-group btn-group-justified">
            ...
            <button id="Calculate" type="button" value="=" class="operand btn btn-primary butnss">=</button>
					   ...
					   <a id ="retrylink" href="full_length_result.action?testno=<s:property value="#session.test_no"/>" class="btn btnn btn-default btn-s-sm btn-test pull-right"></a>

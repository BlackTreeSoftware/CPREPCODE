...
<!-- For Question Index -->
 ...
 <script src="assets/plug-ins/calculator/jquery-ui.min.js" type="text/javascript"></script>
...
<s:hidden id="timeRemaining" value="%{#session.resumeBean.timeRemaining}"></s:hidden>
<s:hidden id="testPattern" value="%{#session.resumeBean.pattern}"></s:hidden>
<s:hidden id="sectionStatus" value="%{#session.resumeBean.section_status}"></s:hidden>
...
<s:hidden id="previousSelection"></s:hidden>
<s:hidden id="selectedText"></s:hidden>
<s:hidden id="remainingTime" name="remainingTime"></s:hidden>
...
<!-- For Start Section  -->
 ...
 <label id="ins" style="display: none"><%=request.getAttribute("ins") %></label>
                    ...
                    <div class="panel panel-default">
                            ...
                            <div class="row">
		                	 ...
		                	 <div class="btn-group btn-group-justified" id='confirm-dialog'>
                                  ...
                                  <a href="full_length_result.action?testno=<s:property value="#session.test_no"/>" class="btn btn-default btn-test" id="_reviewBtn">Review</a>                           
                             ...
                             <a class="btn btn-default btn-test" onclick="getReviewPage()" id="_review"> Review <br>
                              <i class="fa fa-edit hide-icons-f-test"></i>
                                      ...
                                      <!-- javascript:marking()  -->             
                          	 <a href="#" class="btn btn-default btn-test"  id="_mark" onclick="marking()">Mark <br>
                             ...
                             <a href="#" class="btn btn-success btn-test" id="_goToQuestion" onclick="goToQuestion()" disabled="disabled">
...
<div class="well-practice practice-content optionsCheck text-keyup optionsCheck_TcOne optionsCheck_TcTwo optionsCheck_Three instructions" id="question_div">
             ...
             <div class="panel-body">
              ...
              <div class="row" id="_quantInstructions" >
             <div class="col-sm-8 col-sm-offset-2 ">
            
            
             <p  style="font-size: 36px; margin-top:30px;" class="font-bold text-center">GRE FULL LENGTH TEST</p>
             <p class="h4 text-center"><strong>Quant Instructions </strong></p><br>
             <p class="h5 text-center"><strong>20 Questions </strong></p>
             <p class="h5 text-center"><strong>35 Minutes </strong></p><br>
             <ul>
             <li><p align="left"> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is <br>
              ...
              <br>
          	 <center><a class="btn btn-success" href="javaScript:getFullLenthTestQuestions();">Continue</a></center>
             ...
             <p  style="font-size: 36px; margin-top:30px;" class="font-bold text-center">GRE FULL LENGTH TEST</p>
             <p class="h4 text-center"><strong>Verbal Instructions </strong></p><br>
             <p class="h5 text-center"><strong>20 Questions </strong></p>
             <p class="h5 text-center"><strong>30 Minutes </strong></p><br>
             <ul>
             <li><p align="left"> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is <br>
             	that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing <br>             	             	             	
              </p>
            ...
            <br>
             ...
             <p  style="font-size: 36px; margin-top:30px;" class="font-bold text-center">RESUME TEST</p>
             <p class="h4 text-center"><strong>Resume Instructions </strong></p><br>
          ...
          <div id="confirm">
                ...
                <div class="header"><span id="status_btn"></span></div>

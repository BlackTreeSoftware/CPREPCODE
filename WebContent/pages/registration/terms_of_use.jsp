...
<body class="">
 ...
 <section id="content" class="m-t-lg wrapper-md animated fadeInUp" style="margin-top:150px"> 
    ...
    <div class="col-lg-8"></div> <br>
      ...
      <p class="h1" style="padding-top:2%;font-family:Segoe UI"> Terms And Conditions </p><br>

      <p class="text" style="font-family:Segoe UI"><s:property escape="false" value="termsofUseData"/> </p>
      </div>
      </div>      
      </div><!--row close-->
 ...
 <section id="content" class="m-t-lg wrapper-md animated fadeInUp" style="margin-top:150px"> 
    ...
    <div class="container aside-xxxl">
      ...
      <div class="col-lg-8 col-lg-offset-2">
      <p class="h1"> Terms And Conditions </p><br>

      <p class="text"><strong class=" text-lt"><s:property escape="false" value="termsofUseData"/> </p>
      </div>
      </div>      
      </div><!--row close-->
...
<%--  <s:property escape="false" value="termsofUseData"/>  --%>
</body>
</html>
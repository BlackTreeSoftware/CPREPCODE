 ...
 * The Class MailUtil.
 */
public class MailAttachementUtil {
 ...
 */
public static boolean sendMailToOne(String subject,String content,String receipient,String path) throws EmailExceptions{
	boolean flag=false;
	...
	properties.put("mail.smtp.auth","true");
		...
		try {
			...
			//vary
		    message.setContent("<h3>Thank you for Writeing the practise session.</h3> " +
					"<br />" +
		...
		//Send a Message 
		    ...
		    //String filename = "D:\\Development\\crunchprepWorkspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\crunchprep\\assets\\img\\Result\\10278.xls";//change accordingly
	        ...
	        messageBodyPart1.setText("<h3>Thank you for Writeing the practise session.</h3> " +
					"<br />" +
					"<a href='http://www.greenbuds.co.in'>http://www.greenbuds.co.in</a> ");    

...
public class MathQuestions {
 ...
 public static void main(String a[]){
			 ...
			 Integer i[]={1, 3, 2, 3, 4, 1, 5, 2, 2, 3, 4, 5, 2, 1, 1, 1, 4, 5, 3, 4};
	       ...
	       System.out.println("\n Final quiree is: \n\t"+prepareMathQuery(MathAlgorithm._7_4_1_1_3_2_1_1,randomList));
		 ...
		 case _8_4_1_1_3_2_1:
			...
			*/	
			 ...
			 */
			 ...
			 String di3=" group by masters.graph_id having count(*)="+dicount+") AND mast.question_id=que.question_id" ;
			 String end=")";
